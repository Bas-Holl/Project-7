...
<div class="col-md-12 text-center">
    <br/>
    <?php if($access=="accepted"){echo '
        <form method="POST" action="menutoevoegen.php">
                    ...
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            if( isset($_GET["verwijdermenu"])){
                                ...
                                $delete->execute();
                                //header('Location: http://localhost/project7/front-end/menu/menu.php');
                            } ?>
                        </div>
                    ...
                    foreach($result as &$data){       
                        ...
                        ?>
                            <li class="list-group-item">
                                ...
                                <?php if($access=="accepted"){ echo "<br><a href='?verwijderdish=$id'>Verwijder het gerecht</a>"?>
